...
% acc & gyro data gait1
raw{1}=importdata('par1_12km_90_00341957.txt');
raw{2}=importdata('par1_12km_90_00341958.txt');
...
title('Axes of the sensor for the right leg for 12kmh 100% Participant1')
legend('Lower leg','Upper leg')
xlabel('x')
ylabel('y')
zlabel('z')
axis equal
print -depsc ./kneeaxes_right_12kmh_100_id_P1.eps
...
title('Knee angle in gait for right leg for 12kmh 100% Participant1')
xlabel('Gait cycle')
ylabel('Flexion Angle [deg]')
print -depsc ./kneeangel_right_12kmh_100_id_P1.eps
